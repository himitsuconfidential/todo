    ...
    def __init__(self , args , appid_path):
        ...
        if args.input_file is not None:
            ...
            if os.path.isdir(args.input_dir):
                ...
                print("[-] Error: Path " + str(args.input_dir) + " is not directory or not found")
        ...
        for file in files:
            ...
            if os.path.isfile(file):
                ...
                return None
        self.folders_with_time=({i["Local_Path"]:datetime.datetime.fromisoformat(i["Time_Access"]).timestamp() for i in output})
