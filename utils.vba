...
Function ParseExpr(expr As String, ws As Worksheet) As Range
    ...
    If suffix <> "" Then
        ...
        If Left(suffix, 2) = "↑↑" Or Left(suffix, 2) = "↓↓" Or Left(suffix, 2) = "←←" Or Left(suffix, 2) = "→→" Then
            ...
            Select Case Left(suffix, 2)
                ...
                Case "↓↓": Set baseCell = baseCell.End(xlDown): If offsetCount <> 0 Then Set baseCell = baseCell.Offset(offsetCount, 0)
